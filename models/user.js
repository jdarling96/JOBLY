...
class User {
  ...
  /** creates new application and takes in {username, jobId}
   *
   * username and jobId references users and jobs table.
   * if either do not exist then:
   * Throws NotFoundError on violating foreign key constraints.
   **/
